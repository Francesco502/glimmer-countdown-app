...
**v3.3** · 一款基于 **Jetpack Compose** 与 **Material 3** 的 Android 倒计时 / 纪念日应用，支持多语言（中/英）、主题切换、桌面小部件、应用内检查更新与提醒通知，提供完整的农历生日 / 纪念日支持，并可将提醒同步到系统日程。
...
3. 执行构建：
   ...
   ```
   产出路径：`app/build/outputs/apk/direct/release/glimmer-countdown-3-3.apk`（版本号随 gradle.properties 中 VERSION_NAME 变化）
...
| 文档 | 说明 |
|------|------|
| [CHANGELOG.md](CHANGELOG.md) | 版本更新日志（含 v1.0 → v3.3 等） |
