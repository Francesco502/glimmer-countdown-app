...
class SettingsStructureTest {
    ...
    fun songSharedUiComponentsProvide315PolishBuildingBlocks() {
        ...
        assertTrue(source.contains("useLargeTextLayout(LocalDensity.current.fontScale)"))
        assertTrue(source.contains("titleMaxLines = 2"))
    ...
    fun detailScreenCentersSupplementalContentAndKeepsWarningsBelowDetails() {
        ...
        assertTrue(labelRowBlock.contains("val largeTextLayout = useLargeTextLayout(LocalDensity.current.fontScale)"))
        assertTrue(labelRowBlock.contains("if (largeTextLayout)"))
        assertTrue(labelRowBlock.contains("modifier = Modifier.fillMaxWidth()"))
        assertTrue(labelRowBlock.contains("maxLines = 1"))
        assertTrue(labelRowBlock.contains("Modifier.width(DetailSupplementLabelWidth)"))
