...
**版本**：`3.10`（`versionCode=15`）  **发布日期**：`2026-04-10`

## 一、已完成的自动校验

- [x] `gradle.properties` 中 `VERSION_CODE=15`、`VERSION_NAME=3.10` 正确
- [x] `app/build.gradle.kts` 的版本读取、APK 重命名与 Play AAB 构建逻辑正常
- [x] `README.md`、`CHANGELOG.md` 与发布文档已切换到 `3.10`
...
- [x] Direct APK 已输出到 `app/build/outputs/apk/direct/release/glimmer-countdown-3-10.apk`
...
- [ ] 设置“提前 3 天提醒”并同步到系统日程后，应从 3 / 2 / 1 / 0 天连续每天都有日程提醒，而不是只有第 3 天
...
- [ ] 以 `CHANGELOG.md` 中的 `3.10` 小节作为 Release Notes
