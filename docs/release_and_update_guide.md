...
本文档说明当前 `3.13` 版本如何完成签名、构建、发布，以及如何更新 GitHub Release。

## 一、当前状态

| 项目 | 状态 |
|------|------|
| `applicationId` / 版本号 | Direct：`com.example.timeapk` / `3.13`；Play：`com.example.timeapk.play` / `3.13-play` |
...
| Direct APK 命名 | 输出为 `glimmer-countdown-3-13.apk` |
...
- 读取当前版本号
- 提取 `CHANGELOG.md` 中 `3.13` 小节作为 Release Notes
